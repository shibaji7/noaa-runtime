...
with open("LSTM/config.json", "r") as f:
    CONFIG = json.load(f)

with open("LSTM/scaler.pck", "rb") as f:
...
def load_model(fname):
    model = skljson.from_json("basic_regression/" + fname)
    return model
